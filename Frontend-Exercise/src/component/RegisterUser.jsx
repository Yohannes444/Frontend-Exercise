      ...
      <div className="p-8 bg-white shadow-md rounded">
        ...
        {currentPage === 1 && (
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="button" onClick={handleNextPage} className="w-full px-4 py-2 text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:bg-indigo-700">Next</button>
          </form>
        )}
        {currentPage === 2 && (
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="button" onClick={handlePreviousPage} className="w-full mt-4 px-4 py-2 text-white bg-gray-400 rounded-md hover:bg-gray-500 focus:bg-gray-500">Previous</button>
            <button type="button" onClick={handleRegister} className="w-full px-4 py-2 text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:bg-indigo-700">Register</button>
          </form>
        )}
      </div>
    </div>
